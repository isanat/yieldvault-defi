...
export interface IQuickSwapV3PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "fee"
      | "liquidity"
...
export interface IQuickSwapV3Pool extends BaseContract {
  connect(runner?: ContractRunner | null): IQuickSwapV3Pool;
  waitForDeployment(): Promise<this>;

  interface: IQuickSwapV3PoolInterface;
