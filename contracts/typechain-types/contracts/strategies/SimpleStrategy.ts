...
export interface SimpleStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface SimpleStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleStrategy;
