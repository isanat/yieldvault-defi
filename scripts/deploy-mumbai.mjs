...
const AMOY_RPC = 'https://polygon-amoy.g.alchemy.com/v2/demo';
const USDT_ADDRESS = '0x0E1d9Ecb896B85B2b0486e52e89F223773AEc029'; // USDT on Amoy testnet
...
async function main() {
  ...
  // Connect to Mumbai
  const provider = new JsonRpcProvider(MUMBAI_RPC);
