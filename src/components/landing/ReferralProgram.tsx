...
export function ReferralProgram() {
  ...
  const text = mounted ? {
    ...
    commissionNote: 'Commissions are distributed from the deposit fee (5%) and from referred users\' yield earnings',
    depositTitle: 'Deposit Commissions',
    depositDesc: 'Instant commissions when your referrals deposit. Earn from the 5% deposit fee distributed across 5 levels.',
    depositExample: 'Level 1: $1,000 deposit → $20 commission',
