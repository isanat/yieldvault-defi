...
export interface QuickSwapStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface QuickSwapStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): QuickSwapStrategy;
  waitForDeployment(): Promise<this>;

  interface: QuickSwapStrategyInterface;
